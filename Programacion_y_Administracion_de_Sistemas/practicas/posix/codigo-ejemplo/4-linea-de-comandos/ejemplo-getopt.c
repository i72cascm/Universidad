...
int main (int argc, char **argv)
{
   ...
   opterr = 0; 
    ...
    /* getopt() internamente reordena los valores de argv, las primeras posiciones de argv
     corresponden a opciones conocidas ("-") y las últimas, a partir de optind, a opciones no reconocidas.
     Por tanto, getopt va iterando con las opciones ("-"), y devuelve -1 si ya hemos consultado toda la linea
    ...
    (optind) This variable is set by getopt to the index of the next element of the argv array to be processed.
    Once getopt has found all of the option arguments, you can use this variable to determine where the remaining
