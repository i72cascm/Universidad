...
set output "graficoDeterminanteRecursivo.eps"
set key right bottom
set xlabel "Orden de la matriz"
set ylabel "Tiempo en microsegundos"
plot 'datosFinalesDeterminanteRecursivo.txt' using 1:2 t "Tiempo Real", 'datosFinalesDeterminanteRecursivo.txt' using 1:3 t "Tiempo Estimado" w l
_end_
