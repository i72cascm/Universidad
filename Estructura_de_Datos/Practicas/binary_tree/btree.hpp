...
protected:
    ...
    T _item; //objeto del nodo
    typename BTNode<T>::Ref _left; //ref a nodo izq
    typename BTNode<T>::Ref _right; //ref a nodo derch

    /*
    punt nodo izq y punt nodo derech y el item
    si llamamos a izq, retornamos el ARBOL de la izq, lo mismo para la derecha
    la ventaja de los arboles es que se pueden realizar busquedas mas rapidas
    */
