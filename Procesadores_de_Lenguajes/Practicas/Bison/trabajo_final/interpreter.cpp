 ...
 */
 if (argc == 2) 
 {
    ...
    if(yyin == NULL){
      std::cout<<std::endl;
      std::cout<<"ERROR, ese fichero de texto no existe."<<std::endl;
    ...
    if(!strcmp(extension, ".p") == 0){
      std::cout<<std::endl;
      std::cout<<"ERROR, ese fichero de texto no tiene la extensión requerida (.p)."<<std::endl;
      std::cout<<"Finalizando programa..."<<std::endl;
      std::cout<<std::endl;
      return -1;
    }
